...
impl PrometheusExporter {
    ...
    pub fn new() -> Result<Self, MetricsError> {
        ...
        // Consensus metrics
        let consensus_proposals_total = Counter::with_opts(
            Opts::new("dchat_consensus_proposals_total", "Total number of consensus proposals")
        ...
        let consensus_finality_seconds = Histogram::with_opts(
            HistogramOpts::new("dchat_consensus_finality_seconds", "Time to finality for consensus proposals")
                .buckets(vec![0.1, 0.5, 1.0, 2.0, 5.0, 10.0, 30.0])
        ).map_err(|e| MetricsError::RegistrationFailed(e.to_string()))?;
        registry.register(Box::new(consensus_finality_seconds.clone()))
            .map_err(|e| MetricsError::RegistrationFailed(e.to_string()))?;
        
        let consensus_validator_participation = Gauge::with_opts(
            Opts::new("dchat_consensus_validator_participation", "Percentage of validators participating in consensus")
        ).map_err(|e| MetricsError::RegistrationFailed(e.to_string()))?;
        registry.register(Box::new(consensus_validator_participation.clone()))
            .map_err(|e| MetricsError::RegistrationFailed(e.to_string()))?;
        
        let consensus_bft_threshold_violations = Counter::with_opts(
            Opts::new("dchat_consensus_bft_threshold_violations_total", "Total BFT threshold violations")
        ).map_err(|e| MetricsError::RegistrationFailed(e.to_string()))?;
        registry.register(Box::new(consensus_bft_threshold_violations.clone()))
            .map_err(|e| MetricsError::RegistrationFailed(e.to_string()))?;
        
        // Network metrics
        let network_peers_total = Gauge::with_opts(
            Opts::new("dchat_network_peers_total", "Current number of connected peers")
        ).map_err(|e| MetricsError::RegistrationFailed(e.to_string()))?;
        registry.register(Box::new(network_peers_total.clone()))
            .map_err(|e| MetricsError::RegistrationFailed(e.to_string()))?;
        ...
        registry.register(Box::new(network_peer_churn_total.clone()))
            .map_err(|e| MetricsError::RegistrationFailed(e.to_string()))?;
        ...
        let network_messages_total = CounterVec::new(
            Opts::new("dchat_network_messages_total", "Total network messages by type"),
            &["message_type", "direction"]
        ).map_err(|e| MetricsError::RegistrationFailed(e.to_string()))?;
        registry.register(Box::new(network_messages_total.clone()))
            .map_err(|e| MetricsError::RegistrationFailed(e.to_string()))?;
        
        let network_bytes_total = CounterVec::new(
            Opts::new("dchat_network_bytes_total", "Total network bytes by direction"),
            &["direction"]
        ).map_err(|e| MetricsError::RegistrationFailed(e.to_string()))?;
        ...
        registry.register(Box::new(relay_reputation_score.clone()))
            .map_err(|e| MetricsError::RegistrationFailed(e.to_string()))?;
        
        let relay_delivery_proofs_total = Counter::with_opts(
            Opts::new("dchat_relay_delivery_proofs_total", "Total delivery proofs generated")
        ).map_err(|e| MetricsError::RegistrationFailed(e.to_string()))?;
        registry.register(Box::new(relay_delivery_proofs_total.clone()))
            .map_err(|e| MetricsError::RegistrationFailed(e.to_string()))?;
        ...
        registry.register(Box::new(relay_proof_batch_size.clone()))
            .map_err(|e| MetricsError::RegistrationFailed(e.to_string()))?;
        
        let relay_rewards_issued_total = Counter::with_opts(
            Opts::new("dchat_relay_rewards_issued_total", "Total relay rewards issued (smallest currency unit)")
        ).map_err(|e| MetricsError::RegistrationFailed(e.to_string()))?;
        registry.register(Box::new(relay_rewards_issued_total.clone()))
            .map_err(|e| MetricsError::RegistrationFailed(e.to_string()))?;
        ...
        registry.register(Box::new(relay_tier_distribution.clone()))
            .map_err(|e| MetricsError::RegistrationFailed(e.to_string()))?;
        
        // Discovery metrics
        let discovery_queries_total = CounterVec::new(
            Opts::new("dchat_discovery_queries_total", "Total discovery queries by method and result"),
            &["method", "result"]
        ).map_err(|e| MetricsError::RegistrationFailed(e.to_string()))?;
        registry.register(Box::new(discovery_queries_total.clone()))
            .map_err(|e| MetricsError::RegistrationFailed(e.to_string()))?;
        
        let discovery_query_duration_seconds = HistogramVec::new(
            HistogramOpts::new("dchat_discovery_query_duration_seconds", "Discovery query duration by method")
                .buckets(vec![0.01, 0.05, 0.1, 0.5, 1.0, 5.0, 30.0]),
            &["method"]
        ).map_err(|e| MetricsError::RegistrationFailed(e.to_string()))?;
        registry.register(Box::new(discovery_query_duration_seconds.clone()))
            .map_err(|e| MetricsError::RegistrationFailed(e.to_string()))?;
        
        let discovery_cache_operations_total = CounterVec::new(
            Opts::new("dchat_discovery_cache_operations_total", "Total cache operations by type"),
            &["operation", "result"]
        ).map_err(|e| MetricsError::RegistrationFailed(e.to_string()))?;
        registry.register(Box::new(discovery_cache_operations_total.clone()))
            .map_err(|e| MetricsError::RegistrationFailed(e.to_string()))?;
        
        let discovery_peer_count = GaugeVec::new(
            Opts::new("dchat_discovery_peer_count", "Number of discovered peers by method"),
            &["method"]
        ).map_err(|e| MetricsError::RegistrationFailed(e.to_string()))?;
        registry.register(Box::new(discovery_peer_count.clone()))
            .map_err(|e| MetricsError::RegistrationFailed(e.to_string()))?;
        
        // Version negotiation metrics
        let version_negotiations_total = CounterVec::new(
            Opts::new("dchat_version_negotiations_total", "Total version negotiations by result"),
            &["result"]
        ).map_err(|e| MetricsError::RegistrationFailed(e.to_string()))?;
        registry.register(Box::new(version_negotiations_total.clone()))
            .map_err(|e| MetricsError::RegistrationFailed(e.to_string()))?;
        
        let version_negotiation_duration_seconds = Histogram::with_opts(
            HistogramOpts::new("dchat_version_negotiation_duration_seconds", "Version negotiation duration")
                .buckets(vec![0.001, 0.005, 0.01, 0.05, 0.1, 0.5, 1.0])
        ).map_err(|e| MetricsError::RegistrationFailed(e.to_string()))?;
        registry.register(Box::new(version_negotiation_duration_seconds.clone()))
            .map_err(|e| MetricsError::RegistrationFailed(e.to_string()))?;
        
        let version_downgrade_attempts_total = Counter::with_opts(
            Opts::new("dchat_version_downgrade_attempts_total", "Total detected downgrade attempts")
        ).map_err(|e| MetricsError::RegistrationFailed(e.to_string()))?;
        registry.register(Box::new(version_downgrade_attempts_total.clone()))
            .map_err(|e| MetricsError::RegistrationFailed(e.to_string()))?;
        
        let version_major_mismatches_total = Counter::with_opts(
            Opts::new("dchat_version_major_mismatches_total", "Total major version mismatches")
        ).map_err(|e| MetricsError::RegistrationFailed(e.to_string()))?;
        registry.register(Box::new(version_major_mismatches_total.clone()))
            .map_err(|e| MetricsError::RegistrationFailed(e.to_string()))?;
        
        // NAT traversal metrics
        let nat_traversal_attempts_total = CounterVec::new(
            Opts::new("dchat_nat_traversal_attempts_total", "Total NAT traversal attempts by method and result"),
            &["method", "result"]
        ).map_err(|e| MetricsError::RegistrationFailed(e.to_string()))?;
        ...
        let nat_method_success_rate = GaugeVec::new(
            Opts::new("dchat_nat_method_success_rate", "NAT traversal success rate by method (0-1)"),
            &["method"]
        ).map_err(|e| MetricsError::RegistrationFailed(e.to_string()))?;
        registry.register(Box::new(nat_method_success_rate.clone()))
            .map_err(|e| MetricsError::RegistrationFailed(e.to_string()))?;
        
        // Region diversity metrics
        let region_validator_distribution = GaugeVec::new(
            Opts::new("dchat_region_validator_distribution", "Number of validators per region"),
            &["region"]
        ).map_err(|e| MetricsError::RegistrationFailed(e.to_string()))?;
        registry.register(Box::new(region_validator_distribution.clone()))
            .map_err(|e| MetricsError::RegistrationFailed(e.to_string()))?;
        
        let region_diversity_percentage = Gauge::with_opts(
            Opts::new("dchat_region_diversity_percentage", "Maximum region concentration percentage")
        ).map_err(|e| MetricsError::RegistrationFailed(e.to_string()))?;
        registry.register(Box::new(region_diversity_percentage.clone()))
            .map_err(|e| MetricsError::RegistrationFailed(e.to_string()))?;
        
        let region_diversity_warnings_total = Counter::with_opts(
            Opts::new("dchat_region_diversity_warnings_total", "Total region diversity warnings")
        ).map_err(|e| MetricsError::RegistrationFailed(e.to_string()))?;
        registry.register(Box::new(region_diversity_warnings_total.clone()))
            .map_err(|e| MetricsError::RegistrationFailed(e.to_string()))?;
        
        // Slashing metrics
        let slashing_violations_detected_total = CounterVec::new(
            Opts::new("dchat_slashing_violations_detected_total", "Total slashing violations by type"),
            &["violation_type"]
        ).map_err(|e| MetricsError::RegistrationFailed(e.to_string()))?;
        registry.register(Box::new(slashing_violations_detected_total.clone()))
            .map_err(|e| MetricsError::RegistrationFailed(e.to_string()))?;
        
        let slashing_penalties_applied_total = CounterVec::new(
            Opts::new("dchat_slashing_penalties_applied_total", "Total slashing penalties by severity"),
            &["severity"]
        ).map_err(|e| MetricsError::RegistrationFailed(e.to_string()))?;
        registry.register(Box::new(slashing_penalties_applied_total.clone()))
            .map_err(|e| MetricsError::RegistrationFailed(e.to_string()))?;
        
        let slashing_stake_slashed_total = Counter::with_opts(
            Opts::new("dchat_slashing_stake_slashed_total", "Total stake slashed (smallest currency unit)")
        ).map_err(|e| MetricsError::RegistrationFailed(e.to_string()))?;
        registry.register(Box::new(slashing_stake_slashed_total.clone()))
            .map_err(|e| MetricsError::RegistrationFailed(e.to_string()))?;
    ...
    pub fn record_peer_join(&self) {
        self.network_peer_churn_total.with_label_values(&["join"]).inc();
    }
    
    pub fn record_peer_leave(&self) {
        self.network_peer_churn_total.with_label_values(&["leave"]).inc();
    }
    
    pub fn record_peer_latency(&self, peer_id: &str, latency_seconds: f64) {
        self.network_latency_seconds.with_label_values(&[peer_id]).observe(latency_seconds);
    }
    
    pub fn record_message(&self, message_type: &str, direction: &str) {
        self.network_messages_total.with_label_values(&[message_type, direction]).inc();
    }
    
    pub fn record_bytes(&self, direction: &str, bytes: u64) {
        self.network_bytes_total.with_label_values(&[direction]).inc_by(bytes as f64);
    }
    
    // Relay metric helpers
    pub fn set_relay_reputation(&self, relay_id: &str, score: f64) {
        self.relay_reputation_score.with_label_values(&[relay_id]).set(score);
    }
    ...
    pub fn set_relay_tier_count(&self, tier: &str, count: usize) {
        self.relay_tier_distribution.with_label_values(&[tier]).set(count as f64);
    }
    
    // Discovery metric helpers
    pub fn record_discovery_query(&self, method: &str, result: &str) {
        self.discovery_queries_total.with_label_values(&[method, result]).inc();
    }
    
    pub fn record_discovery_duration(&self, method: &str, duration_seconds: f64) {
        self.discovery_query_duration_seconds.with_label_values(&[method]).observe(duration_seconds);
    }
    
    pub fn record_cache_operation(&self, operation: &str, result: &str) {
        self.discovery_cache_operations_total.with_label_values(&[operation, result]).inc();
    }
    
    pub fn set_discovered_peer_count(&self, method: &str, count: usize) {
        self.discovery_peer_count.with_label_values(&[method]).set(count as f64);
    }
    
    // Version negotiation metric helpers
    pub fn record_version_negotiation(&self, result: &str) {
        self.version_negotiations_total.with_label_values(&[result]).inc();
    }
    
    pub fn record_version_negotiation_duration(&self, duration_seconds: f64) {
        self.version_negotiation_duration_seconds.observe(duration_seconds);
    }
    ...
    pub fn record_nat_attempt(&self, method: &str, result: &str) {
        self.nat_traversal_attempts_total.with_label_values(&[method, result]).inc();
    }
    
    pub fn set_nat_success_rate(&self, method: &str, rate: f64) {
        self.nat_method_success_rate.with_label_values(&[method]).set(rate);
    }
    
    // Region diversity metric helpers
    pub fn set_region_validator_count(&self, region: &str, count: usize) {
        self.region_validator_distribution.with_label_values(&[region]).set(count as f64);
    }
    ...
    pub fn record_slashing_violation(&self, violation_type: &str) {
        self.slashing_violations_detected_total.with_label_values(&[violation_type]).inc();
    }
    
    pub fn record_slashing_penalty(&self, severity: &str) {
        self.slashing_penalties_applied_total.with_label_values(&[severity]).inc();
    }
...
static PROMETHEUS_EXPORTER: once_cell::sync::OnceCell<Arc<PrometheusExporter>> = once_cell::sync::OnceCell::new();

/// Initialize the global Prometheus exporter
pub fn initialize_prometheus() -> Result<(), MetricsError> {
    let exporter = PrometheusExporter::new()?;
    PROMETHEUS_EXPORTER.set(Arc::new(exporter))
        .map_err(|_| MetricsError::RegistrationFailed("Prometheus already initialized".to_string()))?;
    Ok(())
}
...
mod tests {
    ...
    fn test_consensus_metrics() {
        ...
        assert!(output.contains("dchat_consensus_proposals_total"), "Should export proposal count");
        assert!(output.contains("dchat_consensus_finality_seconds"), "Should export finality histogram");
        assert!(output.contains("dchat_consensus_validator_participation"), "Should export participation");
    }
    ...
    fn test_network_metrics() {
        ...
        let output = exporter.export().unwrap();
        assert!(output.contains("dchat_network_peers_total"), "Should export peer count");
        assert!(output.contains("dchat_network_peer_churn_total"), "Should export churn");
        assert!(output.contains("dchat_network_latency_seconds"), "Should export latency");
    }
    ...
    fn test_relay_metrics() {
        ...
        let output = exporter.export().unwrap();
        assert!(output.contains("dchat_relay_reputation_score"), "Should export reputation");
        assert!(output.contains("dchat_relay_delivery_proofs_total"), "Should export proof count");
        assert!(output.contains("dchat_relay_proof_batch_size"), "Should export batch size");
    }
    ...
    fn test_discovery_metrics() {
        ...
        let output = exporter.export().unwrap();
        assert!(output.contains("dchat_discovery_queries_total"), "Should export query count");
        assert!(output.contains("dchat_discovery_query_duration_seconds"), "Should export duration");
    }
    ...
    fn test_version_metrics() {
        ...
        let output = exporter.export().unwrap();
        assert!(output.contains("dchat_version_negotiations_total"), "Should export negotiation count");
        assert!(output.contains("dchat_version_downgrade_attempts_total"), "Should export downgrade attempts");
    }
    ...
    fn test_nat_metrics() {
        ...
        let output = exporter.export().unwrap();
        assert!(output.contains("dchat_nat_traversal_attempts_total"), "Should export NAT attempts");
        assert!(output.contains("dchat_nat_method_success_rate"), "Should export success rate");
    }
    ...
    fn test_region_metrics() {
        ...
        let output = exporter.export().unwrap();
        assert!(output.contains("dchat_region_validator_distribution"), "Should export region distribution");
        assert!(output.contains("dchat_region_diversity_percentage"), "Should export diversity percentage");
    }
    ...
    fn test_slashing_metrics() {
        ...
        let output = exporter.export().unwrap();
        assert!(output.contains("dchat_slashing_violations_detected_total"), "Should export violations");
        assert!(output.contains("dchat_slashing_penalties_applied_total"), "Should export penalties");
        assert!(output.contains("dchat_slashing_stake_slashed_total"), "Should export slashed stake");
    }
    ...
    fn test_export_format() {
        ...
        assert!(output.contains("dchat_"), "All metrics should have dchat_ prefix");
    }
    ...
    fn test_histogram_buckets() {
        ...
        let output = exporter.export().unwrap();
        assert!(output.contains("_bucket"), "Histogram should export buckets");
