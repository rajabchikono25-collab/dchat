  ...
  [792],
  {
          ...
          try {
            ...
            if ("type" in o)
              if ("redirect-internal" === o.type)
                ...
                return (
                  q({ url: o.destination, router: this }),
                  new Promise(() => {})
                );
            let i = o.Component;
            if (
            ...
            let l = n.shallow && W.route === (null != (S = o.route) ? S : ea),
            ...
            if (
              ...
              if (o.error)
                throw (
                  B || V.events.emit("routeChangeError", o.error, J, Q),
                  o.error
                );
    ...
    6450: (e, t, r) => {
          ...
          i
            ...
            .then((r) => {
              ...
              return Promise.resolve(
                ...
                eo({ ...e, err: u, Component: s, styleSheets: l, props: t }),
              );
            })
        );
      }
      ...
      function eo(e) {
        ...
        let P =
          ((t = ee ? er : en),
          (0, m.jsx)(ea, { callbacks: [t, _], children: y }));
        return (
          Z
