        ...
        constructor(a) {
          ((this.batcher = d.Batcher.create({
            cacheKeyFn: ({ key: a, isOnDemandRevalidate: b }) =>
              `${a}-${b ? "1" : "0"}`,
            schedulerFn: e.scheduleOnNextTick,
          })),
            (this.minimal_mode = a));
        }
        async get(a, b, c) {
          ...
          let {
              ...
              isFallback: g = !1,
              isRoutePPREnabled: h = !1,
              waitUntil: i,
            } = c,
            j = await this.batcher.batch(
              ...
              (j, k) => {
                let l = (async () => {
                  ...
                  if (
                    this.minimal_mode &&
                    (null == (i = this.previousCacheItem) ? void 0 : i.key) ===
                      j &&
                    this.previousCacheItem.expiresAt > Date.now()
                  )
                    return this.previousCacheItem.entry;
                  let l = (0, f.routeKindToIncrementalCacheKind)(c.routeKind),
                    m = !1,
                    n = null;
                  try {
                    if (
                      ...
                      !e &&
                      (k(n), (m = !0), !n.isStale || c.isPrefetch)
                    )
                      return null;
                    let i = await b({
                      hasResolved: m,
                      previousCacheEntry: n,
                      isRevalidating: !0,
                    });
                    if (!i)
                      return (
                    ...
                    let o = await (0, f.fromResponseCacheEntry)({
                      ...i,
                      isMiss: !n,
                    });
                    if (!o)
                    ...
                    if (null == n ? void 0 : n.cacheControl) {
                      let b = Math.min(
                          Math.max(n.cacheControl.revalidate || 3, 3),
                          30,
                        ),
                        c =
                          void 0 === n.cacheControl.expire
                            ? void 0
                            : Math.max(b + 3, n.cacheControl.expire);
                      await d.set(a, n.value, {
                        cacheControl: { revalidate: b, expire: c },
                        isRoutePPREnabled: h,
                        isFallback: g,
                      });
                    }
                    if (m) return (console.error(b), null);
                    throw b;
                  }
                })();
                return (i && i(l), l);
          ...
          return (0, f.toResponseCacheEntry)(j);
        }
      }
    },
    1384: (a, b, c) => {
      ...
      class t {
        ...
        trace(...a) {
          ...
          let [c, d, h] = a,
            ...
            m = k.spanName ?? c;
          if (
            (!e.NextVanillaSpanAllowlist.includes(c) &&
          ...
          let n = this.getSpanContext(
            ...
            s = !1;
          n
            ? (null == (b = i.getSpanContext(n)) ? void 0 : b.isRemote) &&
              (s = !0)
        ...
        wrap(...a) {
          ...
          return e.NextVanillaSpanAllowlist.includes(c) ||
            "1" === process.env.NEXT_OTEL_VERBOSE
            ? function () {
                let a = d;
                "function" == typeof a &&
            ...
            for (; b.$$typeof === o; ) {
              ...
              if (j === d.chunk) b = d.value;
                ...
                switch (j.status) {
                  ...
                  case "pending":
                    (h.splice(0, i - 1),
                      null === j.value ? (j.value = [a]) : j.value.push(a),
                      null === j.reason ? (j.reason = [a]) : j.reason.push(a));
                    return;
                  case "halted":
                    return;
                  default:
